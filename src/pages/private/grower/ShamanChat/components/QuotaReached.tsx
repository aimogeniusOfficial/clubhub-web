...
const QuotaReached = (): JSX.Element => {
  // This is a placeholder for the Quota Reached page
  return (
    <Center sx={{ flexGrow: 1 }}>
      <Stack align='center' p='lg'>
        <Alert icon={<IconAlertCircle size={16} />} title='Oh no!' color='red'>
          Unfortunately our Database reached its limit, Sorry for inconvinience. Come back again
